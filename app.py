...
def extract_facts(message, reply):
    facts = []
    keywords = ["اسمي", "عمري", "أنا من", "انا من", "أنا بشتغل", "انا بشتغل", "أحب", "بحب", "my name is", "i am", "i live"]
    for kw in keywords:
        if kw in message.lower():
            facts.append(f"المستخدم قال: {message}")
            break
    return facts
